module Test.Puregres.SelectCols where

import Prelude

import Puregres.SelectCols (Direction(..), SelectEnded, endSelect, from, inner_join, on, order_by, select, whereAny, whereQuery, whereVal, (++))
