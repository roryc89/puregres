...
const getArgType = (tables, fromClause, fields) => {
  ...
  console.log('tables.get(table)', tables.get(table))
...
const getTablesFromTableExpression = (tableExpression) => {
  ...
  if (tableExpression.JoinExpr) {
    return [
      tableExpression.JoinExpr.larg.RangeVar.relname,
      tableExpression.JoinExpr.rarg.RangeVar.relname
    ]
  }
  return []
}
